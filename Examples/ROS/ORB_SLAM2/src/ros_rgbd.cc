...
public:
    ...
    {
	   //创建ROS的发布节点
	   pub_rgb= nh.advertise<sensor_msgs::Image> ("/rgb_to_depth/image_raw", 10); 
	   pub_depth= nh.advertise<sensor_msgs::Image> ("/depth/image_raw", 10); 
...
int main(int argc, char **argv)
{
    ...
    // azure kinect的节点
    message_filters::Subscriber<sensor_msgs::Image> rgb_sub(nh, "/rgb_to_depth/image_raw", 10);
    message_filters::Subscriber<sensor_msgs::Image> depth_sub(nh, "/depth/image_raw", 10);
